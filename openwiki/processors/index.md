...
- [Answer structuring and citation verification](validation.md) - How raw answers become structured cited statements, how leaked prompt scaffolding and unsupported citations are removed, the exact fuzzy citation matching rule/threshold, and the exact fallback outcomes.
