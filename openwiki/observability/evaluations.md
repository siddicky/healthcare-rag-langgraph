...
Routing decisions are gated separately: see [routing gates](routing-evals.md) for the paired query/safety arm comparison, and the [retrieval-arm gate](../retrieval/retrieval-arms.md) for backend comparisons.
